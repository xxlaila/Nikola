...
class Asset(models.Model):
    ...
    admin = models.ForeignKey('MyUser', verbose_name=u'资产管理员', null=True, blank=True, on_delete=models.CASCADE)
...
class Server(models.Model):
    ...
    sub_asset_type = models.SmallIntegerField(choices=sub_assset_type_choices, verbose_name="服务器类型", default=3)
    created_by = models.CharField(choices=created_by_choices, max_length=64, default='auto')  # auto: auto created,   manual:created manually
    ...
    host_name = models.CharField('Asset', '主机名', max_length=64, blank=True, null=True)
...
class Disk(models.Model):
    ...
    asset = models.ForeignKey('Asset', on_delete=models.CASCADE)
    sn = models.CharField(u'SN号', max_length=128, blank=True, null=True)
    disk_name = models.CharField(u'磁盘号', max_length=64, blank=True, null=True)
    ...
    disk_capacity = models.CharField(u'磁盘容量GB', max_length=128, blank=True, null=True)
    disk_iface_choice = (
        ('SATA', 'SATA'),
        ('SAS', 'SAS'),
        ('SCSI', 'SCSI'),
...
class BusinessUnit(models.Model):
    ...
    # contact = models.ForeignKey('MyUser',default=None)
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey('MyUser', verbose_name=u'事件源', on_delete=models.CASCADE)
    memo = models.TextField(u'备注', blank=True, null=True)
...
class NewAssetApprovalZone(models.Model):
    ...
    host_name = models.CharField('Asset', max_length=64, blank=True, null=True)
    ...
    diskname = models.CharField(max_length=64, blank=True, null=True)
 #   disksize = models.CharField(max_length=64, blank=True, null=True)
    ...
    approved_by = models.ForeignKey('MyUser', verbose_name=u'批准人', blank=True, null=True, on_delete=models.CASCADE)
