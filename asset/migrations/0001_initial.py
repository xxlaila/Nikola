# Generated by Django 2.1.1 on 2018-10-12 02:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('securitydevice', '安全设备'), ('securitydevice', '机房设备'), ('software', '软件资产')], default='server', max_length=64, verbose_name='类型')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('host_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='主机名')),
                ...
                ('disksize', models.CharField(blank=True, max_length=64, null=True, verbose_name='磁盘名')),
                ('diskname', models.CharField(blank=True, max_length=64, null=True, verbose_name='磁盘大小')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disk_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='磁盘号')),
                ...
                ('disk_capacity', models.FloatField(verbose_name='磁盘容量GB')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='Asset')),
                ...
                ('disksize', models.CharField(blank=True, max_length=64, null=True)),
                ('diskname', models.CharField(blank=True, max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, 'PC服务器'), (1, '刀片机'), (2, '小型机'), (3, '虚拟机')], default=3, verbose_name='服务器类型')),
                ('created_by', models.CharField(choices=[('auto', 'Auto'), ('manual', 'Manual')], default='auto', max_length=64)),
                ('model', models.CharField(blank=True, max_length=128, null=True, verbose_name='型号')),
                ...
                ('主机名', models.CharField(blank=True, max_length=64, null=True, verbose_name='Asset')),
                ('磁盘名', models.CharField(blank=True, max_length=64, null=True, verbose_name='Asset')),
                ('磁盘大小', models.CharField(blank=True, max_length=64, null=True, verbose_name='Asset')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='asset.Asset')),
