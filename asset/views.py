...
from asset import core, models, asset_handle, utils, admin
import json
...
def new_assets_approval(request):
    if request.method == 'POST':
        ...
        return render(request, 'asset/new_assets_approval.html', {'new_assets': new_assets})


def asset_report_test(request):
    return render(request, 'asset/asset_report_test.html')


@login_required
def acquire_asset_id_test(request):
    return render(request, 'asset/acquire_asset_id_test.html')
...
def asset_list(request):
    ...
    return render(request, 'asset/assets.html', {'table_obj': table_obj,
                                                  'paginator': paginator})
...
def asset_category(request):
    ...
    if request.is_ajax():
        ...
        return render(request, 'asset/asset_category.html', {'category_type': category_type})
...
def event_center(request):
    ...
    return render(request,'asset/event_center.html',{'table_obj': table_obj,
                                                  'paginator': paginator})